<div {{ $attributes->class(['flex flex-col items-center gap-4 py-10 text-center']) }}>
    <span class="relative flex h-12 w-12 shrink-0 items-center justify-center">
        <span class="empty-state-ping absolute inset-0 rounded-full border-[3px] border-fg"></span>
        <span class="relative flex h-12 w-12 items-center justify-center rounded-full border-[3px] border-fg bg-surface text-fg">
