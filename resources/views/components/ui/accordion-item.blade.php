...
<details class="group border-b-[3px] border-fg py-5 last:border-b-0" @if ($open) open @endif>
    <summary class="flex cursor-pointer list-none items-center justify-between gap-4 text-fg marker:content-none [&::-webkit-details-marker]:hidden">
        ...
        <span class="relative flex h-8 w-8 shrink-0 items-center justify-center rounded-full border-[3px] border-fg text-fg transition-colors duration-200 group-open:bg-primary group-open:text-on-accent">
