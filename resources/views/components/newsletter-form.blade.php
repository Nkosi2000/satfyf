...
<div {{ $attributes }}>
    ...
    >
        ...
        <input
            ...
            value="{{ old('email') }}"
            class="w-full rounded-full border border-hairline-strong bg-surface px-4 py-2.5 text-sm font-bold text-fg placeholder:text-faint placeholder:font-normal focus:border-primary-soft"
        />
