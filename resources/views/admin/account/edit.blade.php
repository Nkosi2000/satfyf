<x-admin.layout title="My Account">
    <div class="max-w-md rounded-xl border border-slate-200 bg-white p-6">
        ...
        <form method="POST" action="{{ route('admin.account.password.update') }}" class="mt-4 flex flex-col gap-5">
            ...
            <button type="submit" class="rounded-lg bg-slate-900 px-4 py-2 text-sm font-medium text-white hover:bg-slate-800">Update password</button>
        </form>
    </div>
</x-admin.layout>
